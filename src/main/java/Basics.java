...
public class Basics {
    ...
    public static void main(final String[] args) {
        ...
        /* TEST (Task 1): Write a line of code below that prints the string
         *                Hello World!
         */
        ...
        /*
         * TEST (Task 2): Create a variable named my_variable and assign it the
         *                value 100.
         */
        int my_variable = 100;
        ...
        /*
         * TEST (Task 3): Create a for-loop that loops from 10 to 0, printing
    ...
    public static String split(String to_split) {
        /* TEST (Task 4): Complete this method body.
    ...
    public static int oddSum(int[] arr) {
        ...
        /* TEST (Task 5): Complete this method body using a for-loop.
